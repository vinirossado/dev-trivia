...
namespace DevTrivia.API.Migrations
{
    ...
    [Migration("20260323074131_AddUserIdIntoMatches")]
    partial class AddUserIdIntoMatches
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DevTrivia.API.Capabilities.PlayerStats.Database.Entities.PlayerStatsEntity", b =>
                {
                    ...
                    b.Property<long>("TotalCorrect")
                        .HasColumnType("bigint");

                    b.Property<long>("TotalMatches")
                        .HasColumnType("bigint");
